...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ImageCrop.scale'
        db.delete_column(u'mediacat_imagecrop', 'scale')

        # Deleting field 'ImageCrop.score'
        db.delete_column(u'mediacat_imagecrop', 'score')

        # Adding index on 'ImageCrop', fields ['height']
        db.create_index(u'mediacat_imagecrop', ['height'])

        # Adding index on 'ImageCrop', fields ['width']
        db.create_index(u'mediacat_imagecrop', ['width'])

        # Adding index on 'ImageCrop', fields ['key']
        db.create_index(u'mediacat_imagecrop', ['key'])


    def backwards(self, orm):
        # Removing index on 'ImageCrop', fields ['key']
        db.delete_index(u'mediacat_imagecrop', ['key'])

        # Removing index on 'ImageCrop', fields ['width']
        db.delete_index(u'mediacat_imagecrop', ['width'])

        # Removing index on 'ImageCrop', fields ['height']
        db.delete_index(u'mediacat_imagecrop', ['height'])

        # Adding field 'ImageCrop.scale'
        db.add_column(u'mediacat_imagecrop', 'scale',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'ImageCrop.score'
        db.add_column(u'mediacat_imagecrop', 'score',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=40),
                      keep_default=False)
