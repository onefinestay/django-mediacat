...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.xmp_data'
        db.add_column(u'mediacat_image', 'xmp_data',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Image.exif_data'
        db.add_column(u'mediacat_image', 'exif_data',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.xmp_data'
        db.delete_column(u'mediacat_image', 'xmp_data')

        # Deleting field 'Image.exif_data'
        db.delete_column(u'mediacat_image', 'exif_data')
